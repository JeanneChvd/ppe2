...
class PdoM2l
{
    ...
    {
        $req = "select departement.code as codeDep, count(ligue.nom) as nbLigue ,departement.nom as nomDep
           from departement left join ligue on ligue.codeDep=departement.code group by departement.nom";
    ...
    {
        $req = "select ligue.id as idLigue, ligue.nom as nomLigue, ligue.urlSiteWeb  as urlLigue, ligue.olympique as olymp 
		    from  ligue where codeDep ='$code'";
    ...
    public function getInfosLigue($idLigue)
    {
        $req = "select ligue.id as idLigue, ligue.nom as nomLigue, ligue.adresseRue as adrLigue, ligue.cp as cpLigue, 
                ligue.ville as villeLigue, ligue.emailContact as emailLigue, ligue.urlSiteWeb as urlLigue
    ...
    {
        $req = "select impression.libelle as libelle, impression.pageMinute as pageMinute
                from impression";
